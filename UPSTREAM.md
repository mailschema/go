...
Version `v0.1.1` derives from [`mailschema/mailschema@f630ec5`](https://github.com/mailschema/mailschema/commit/f630ec5569e7167114fb2a39a10548febfa6b979).
...
The canonical contracts live in the main MailSchema repository. This repository owns the Go package surface and its release history.
